...
export const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, error, helperText, id, label, rows = 4, ...props }, ref) => {
    ...
    return (
      <div className="grid w-full gap-1.5">
        ...
        <textarea
          ...
          rows={rows}
          className={cn(
            'min-h-24 w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm transition-colors',
...
/*
Example:
<Textarea label="Notes" placeholder="Write a short note" />
*/
